...
public class Math3D {
    ...
    public static bool PlanePlaneIntersection(out Vector3 linePoint,
                                              out Vector3 lineVec,
    ...
    public static void PlaneFrom3Points(out Vector3 planeNormal,
    ...
    public static void TransformWithParent(out Quaternion childRotation,
    ...
    public static void PreciseAlign(ref GameObject gameObjectInOut,
                                    Vector3 alignWithVector,
                                    Vector3 alignWithNormal,
        ...
        //Set the rotation.
        LookRotationExtended(ref gameObjectInOut,
            alignWithVector,
            alignWithNormal,
            triangleForward,
            triangleNormal);
    ...
    public static void VectorsToTransform(ref GameObject gameObjectInOut,
    ...
    public static float MouseDistanceToLine(Vector3 linePoint1, Vector3 linePoint2) {
        ...
        mousePosition = new Vector3(Event.current.mousePosition.x,
            currentCamera.pixelHeight - Event.current.mousePosition.y,
            0f);
    ...
    public static bool IsLineInRectangle(Vector3 linePoint1,
                                         Vector3 linePoint2,
                                         Vector3 rectA,
                                         Vector3 rectB,
                                         Vector3 rectC,
    ...
    public static bool IsPointInRectangle(Vector3 point,
                                          Vector3 rectA,
                                          Vector3 rectC,
                                          Vector3 rectB,
                                          Vector3 rectD) {
    ...
    public static bool AreLineSegmentsCrossing(Vector3 pointA1,
        ...
        var valid = ClosestPointsOnTwoLines(out closestPointA,
            out closestPointB,
            pointA1,
            lineVecA.normalized,
            pointB1,
